...
from .models import Tour, Booking, Review, Category
...
class TourSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Tour
        fields = ["id", "name", "description", "price", "start_date", "end_date", "category", "category_id", "is_active", "reviews", "photos", "photo_urls"]
